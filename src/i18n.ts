...
const resources = {
  en: {
    translation: {
      ...
      hero: {
        title: 'Less Noise, More Truth.',
        slogan: 'Paws for Web3',
        description: 'Redefining REACH: Closer, Truer, More Effective. CAT Ambassador Team helps brands build an agile network that directly reaches new user ecosystems. We are not middlemen, but your most sensitive market nerve endings.',
  ...
  zh: {
    translation: {
      ...
      hero: {
        title: '远离噪声，拥抱真实！',
        slogan: 'Paws for Web3',
        description: '重新定义"触达"：更近，更真，更有效。猫猫大使团，助力品牌构建直达新用户生态的敏捷网络。我们不是中间商，而是您最敏锐的市场神经末梢。',
  ...
  'zh-TW': {
    translation: {
      ...
      hero: {
        title: '遠離噪聲，擁抱真實！',
        slogan: 'Paws for Web3',
        description: '重新定義「觸達」：更近，更真，更有效。貓貓大使團，助力品牌構建直達新用戶生態的敏捷網絡。我們不是中間商，而是您最敏銳的市场神經末梢。',
